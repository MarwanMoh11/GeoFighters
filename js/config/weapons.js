...
export const WEAPONS = {
    ...
    SHARD_SCATTER: {
        ...
        getFireRate: function () { return this.baseFireRate * Math.pow(0.9, this.level - 1); }, getDamage: function () { return this.baseDamage + (this.level - 1) * 2; }, getProjectileCount: function () { return this.baseProjectileCount + (this.level - 1) * 1; }
    },
    VERTEX_VOLLEY: {
